declare global {
  interface Window { __VECTOR__?: { origin: string; token: string; version?: string; instance?: string } }
}

export function vectorEndpoint(route: 'battles' | 'activity-teams'): { url: string; headers: Record<string, string> } | null {
